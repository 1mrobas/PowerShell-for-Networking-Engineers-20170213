...
# $zoneset=Read-host -Prompt "Zoneset:"
# $outFile = Read-Host -Prompt "Output zone cfg file: "
# $outFile2 = Read-Host -Prompt "Output zoneset cfg file: "

$csvStorageList="zone-PURE-B.csv"
$csvServerList="zone-srv-B.csv"

$fabricVSAN="21"
$zoneset="VSAN21ZONESET"
$outFile = $date+"-PURE-zone-21.txt"
$outFile2 = $date+"-PURE-zoneset-21.txt"
